        ...
        if (isVisualImageLoader) {
            ...
            const renderGrid = () => {
                ...
                if (node.comfyClass === "FavoritePromptLoader") {
                    folder = app.ui.settings.getSettingValue("LeafFlow.3.1 ⭐ Favorites Save Folder Path") || app.ui.settings.getSettingValue("LeafFlow.FavoritesFolder", "output/favorites");
